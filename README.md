...
Сразу после регистрации пользователь не активен, его активируют из админки
 ![api](https://wmpics.pics/di-0V5T.png)
    ...
    При создании по умолчанию пользователь не активен, is_active=False. Но accaunt = True. Пользователь может сменить единоразово на accaunt = False. В админке это отразится и даст сигнал админу на удаление аккаунта. 
